...
import { catchError, delay, finalize, flatMap, map, take, tap } from 'rxjs/operators';
...
export class OperatorsComponent implements OnInit {
	constructor(private vs: VouchersService, private httpClient: HttpClient, private ds: DoublerService) {}
		...
		this.httpClient
			...
			.pipe(
				flatMap((data) => {
					...
					return this.httpClient.get<Account>(`${environment.apiUrl}accounts/${acctID}`);
				})
			)
